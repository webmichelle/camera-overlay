...
export class WebcamComponent implements AfterViewInit, OnDestroy {
    ...
    private static getDeviceIdFromMediaStreamTrack(
        ...
        if (
            ...
            return mediaStreamTrack.getSettings().deviceId ?? null;
        } else if (
    ...
    private static getFacingModeFromMediaStreamTrack(
        ...
        if (mediaStreamTrack) {
            if (
                ...
                return mediaStreamTrack.getSettings().facingMode ?? null;
            } else if (
                mediaStreamTrack.getConstraints &&
                mediaStreamTrack.getConstraints() &&
    ...
    private static getValueFromConstrainDOMString(
        ...
        if (constrainDOMString) {
            if (constrainDOMString instanceof String) {
                ...
                if (
                    (constrainDOMString as ConstrainDOMStringParameters).exact
                ) {
                    return String(
                    ...
                    (constrainDOMString as ConstrainDOMStringParameters).ideal
                ) {
                    return String(
                        (constrainDOMString as ConstrainDOMStringParameters)
                            .ideal
    ...
    public takeSnapshot(): void {
        ...
        if (this.captureImageData) {
            imageData =
                context2d?.getImageData(0, 0, _canvas.width, _canvas.height) ??
                null;
        }
        ...
        if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
            ...
            navigator.mediaDevices
                ...
                .then((stream: MediaStream) => {
                    ...
                    this.activeVideoSettings = stream
                        .getVideoTracks()[0]
                        .getSettings();
